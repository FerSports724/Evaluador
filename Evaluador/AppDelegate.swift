...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        copiarDBaDirectorio(nombreDB: "Evaluacion")
    ...
    func copiarDBaDirectorio(nombreDB:String){
        ...
        /*Pasar en archivo de nuestra BD al Path de Carpeta de Documentos*/
        if objetoFileHelper.existeArchivoEnDocumentos(nombreArchivo: nombreDB){
            ...
            do{
                ...
                print("No se ha copiado el archivo.")
            }
        }
